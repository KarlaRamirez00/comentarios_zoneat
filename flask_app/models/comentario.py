...
class Comentario:
    ...
    @classmethod
    def save(cls, form):
        #form = {"comentario" : "contenido de la publicacion", "usuario_id" : 1}
    ...
    #Metodo para obtener los comentarios de una Película (Incluye Bonus: "Los comentarios se despliegan en orden de más reciente a más antiguo")
    @classmethod
    ...
    #Este metodo lo agregué para poder hacer el Bonus en que un usuario puede borrar sus propios comentarios
    @classmethod
